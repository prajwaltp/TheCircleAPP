...
const AvailableCourses = () => {
  ...
  searchString:searchTerm
            ...
            const response = await fetch("http://localhost:3001/get-registrations-by-studentid/",requestOptions)
                    ...
                    <div className="col-md-4" key={index}>
                        <div className="card mb-4">
                            <div className="card-body">
                                ...
                                <p className="card-text">StartDate: {formatDate(new Date(course.startDate))}</p>
                                <p className="card-text">EndDate: {formatDate(new Date(course.endDate))}</p>
